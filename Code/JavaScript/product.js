var price, TrueFalse, countFalse, color, number, msg, checknumber, YesOrNo, YesOrNo2, itemname, 
itemnum, itemprice, itemstyle, itemremarks, HowmanyProducts = 0;
var namelist = []//, numlist = [], pricelist = [], stylelist = [], remarkslist = [], Numberlist=[];
...
function AddToCart(info)
{
	...
	else
	{
		...
		else
		{
			...
			{
				//alert("dahere")
				//ProductNUMhowmany = localStorage.getItem("PRODUCTNUM");
				NUMProduct = localStorage.getItem("NUMPRODUCTID");
				...
				//let productNum2 = ProductNUMhowmany+","+productNum;
				//localStorage.setItem("PRODUCTNUM",productNum2);
